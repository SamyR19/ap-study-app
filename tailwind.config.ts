...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      colors: {
        // Primary - Warm orange/coral for CTAs and active states
        primary: {
          ...
          300: "#F4B8A3",
          400: "#EC9474",
          500: "#E07856", // Main primary
          600: "#CC5A38",
          700: "#AB462B",
          800: "#8D3B28",
          900: "#753526",
        },
        // Secondary - Soft peach for backgrounds and accents
        secondary: {
          DEFAULT: "hsl(var(--secondary))",
          foreground: "hsl(var(--secondary-foreground))",
          50: "#FDF9F7",
          100: "#FAF0EA",
          200: "#F4D5C6", // Main secondary
          300: "#EEBDA8",
          400: "#E49B7D",
          500: "#D87B5A",
          600: "#C45F42",
        ...
        // Neutral warm - Cream/beige tones
        cream: {
          50: "#FEFDFB",
          100: "#FAF9F6", // Lightest
          200: "#F5F3EF", // Light
          300: "#E8E4DD", // Border color
          400: "#D4CFC4",
          500: "#B8B1A4",
          600: "#9A9285",
          700: "#7D766A",
        ...
        // Text colors
        charcoal: {
          DEFAULT: "#2D2D2D", // Deep charcoal for headings
          light: "#6B6B6B",   // Medium gray for body
          muted: "#8F8F8F",   // Muted text
        },
        // Success - Soft green
        success: {
          DEFAULT: "#6B9E78",
